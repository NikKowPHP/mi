export const profileData = {
  ...
  tagline: "Web Full Stack Developer | React | Next.js | Node.js | PHP",
  ...
  professionalObjective:
    "To leverage my full-stack development skills in creating innovative, scalable web applications that deliver exceptional user experiences while continuously expanding my technical expertise in emerging technologies.",
  contactInfo: {
  ...
  socialLinks: [
    ...
    { name: "Email", url: "mailto:kawaliou.mikita@gmail.com", icon: "mail" },
  ],
  languages: [
    {
      name: "Russian",
